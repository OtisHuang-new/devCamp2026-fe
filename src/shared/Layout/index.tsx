  ...
  return (
    <div className="flex w-full h-screen overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-w-[50%] relative pl-[100px] pr-[40px]">
          <Outlet />
        </div>

        {/* CỘT 3: PHẢI (UserProfile + Dynamic Content) */}
        {/* Thêm sticky top-0 self-start h-screen để ghim cột này đứng yên khi cuộn */}
        <div className="w-[400px] shrink-0 px-6 pt-4 flex flex-col gap-8 z-10 sticky top-0 self-start h-screen overflow-y-auto custom-scrollbar [scrollbar-gutter:stable]">
